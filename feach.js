  ...
  fetch(urlSearchMovies)
    ...
    .then((searchMovies) => {
      for (let i = 0; i < searchMovies.results.length; i++) {
        ...
        let card = `<div class="col-lg-2 col-md-3 col-sm-4 col-6">
        <button class="cards border-0 rounded shadow-lg"style="width: 170px;height: 260px;background-image: url(${searchMovies.results[i].image});  background-size: cover; background-position: center;"
